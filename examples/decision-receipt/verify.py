...
# Recomputes content roots, checks the evidenceRef binding, verifies the Bitcoin anchor.
...
ref = json.load(open("decision_receipt.json"))["predicate"]["evidenceRefs"][0]["digest"]["sha256"]
ok = True
...
print("[3] Bitcoin anchor over the decision content root")
